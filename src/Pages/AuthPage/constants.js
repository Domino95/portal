// tutaj mamy typy formularza
export const LOGIN_TYPE = "LOGIN_TYPE";
export const REGISTER_TYPE = "REGISTER_TYPE";

//tutaj mamy errory, których będziemy używali

export const inputs_incorrect = "Uzupełnij wszystkie pola";
...
// tutaj mamy typy inpuptow
export const EMAIL = "EMAIL";
export const PASSWORD = "PASSWORD";
export const REP_PASSWORD = "REP_PASSWORD";
